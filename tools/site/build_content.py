...
page('founder/index.html',
     ...
     og='https://flarestamina.com/founder/og.png?v=2',
...
page('teachers/index.html',
     ...
     og='https://flarestamina.com/teachers/og.png?v=2',
     current='/teachers/',
     extra_head='<script type="application/ld+json">\n' + '{"@context": "https://schema.org", "@graph": [{"@type": "WebPage", "@id": "https://flarestamina.com/teachers/#page", "url": "https://flarestamina.com/teachers/", "name": "For teachers — Flarestamina", "description": "One account per student, every result tracked, 100+ free IELTS tests and affordable full mocks.", "inLanguage": "en", "isPartOf": {"@id": "https://flarestamina.com/#website"}, "publisher": {"@id": "https://flarestamina.com/#org"}}, {"@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "How do students join my class on Flarestamina?", "acceptedAnswer": {"@type": "Answer", "text": "Students register once with a phone number. Every test on the site then recognises them, so there is no name-typing and no fake names."}}, {"@type": "Question", "name": "Can I see what my students practised?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Each finished test is saved with the student\'s name and phone, so you can see who practised what and when."}}, {"@type": "Question", "name": "What does it cost for a class?", "acceptedAnswer": {"@type": "Answer", "text": "Listening, Reading, Cambridge 21, Writing and Speaking labs are free. Full computer-delivered mock exams are 10,000 UZS."}}]}, {"@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Flarestamina", "item": "https://flarestamina.com/"}, {"@type": "ListItem", "position": 2, "name": "For teachers", "item": "https://flarestamina.com/teachers/"}]}]}' + '\n</script>\n',
     uz={
...
<section>
  <div class="wrap narrow">
    <div class="grid c2">
      <div class="card reveal"><p class="kicker">01</p><h2 style="margin-top:.75rem;font-size:1.1rem" data-i18n="t1">One account per student</h2><p class="muted" style="margin-top:.5rem;font-size:.9rem;line-height:1.7" data-i18n="b1">Students register once with a phone number — every test on the site recognizes them. No name-typing, no fake names.</p></div>
      <div class="card reveal"><p class="kicker">02</p><h2 style="margin-top:.75rem;font-size:1.1rem" data-i18n="t2">Every result, tracked</h2><p class="muted" style="margin-top:.5rem;font-size:.9rem;line-height:1.7" data-i18n="b2">Each finished test is saved with the student’s name and phone — you always know who practised what, and when.</p></div>
      <div class="card reveal"><p class="kicker">03</p><h2 style="margin-top:.75rem;font-size:1.1rem" data-i18n="t3">100+ free tests, affordable mocks</h2><p class="muted" style="margin-top:.5rem;font-size:.9rem;line-height:1.7" data-i18n="b3">Listening, Reading, Cambridge 21, Writing and Speaking labs — free. Full computer-delivered mocks at 10,000 UZS.</p></div>
      <div class="card reveal"><p class="kicker">04</p><h2 style="margin-top:.75rem;font-size:1.1rem" data-i18n="t4">Class reports</h2><p class="muted" style="margin-top:.5rem;font-size:.9rem;line-height:1.7" data-i18n="b4">Message us and we’ll set up a results view for your group — daily activity, scores, streaks.</p></div>
    </div>
...
page('privacy/index.html',
     ...
     og='https://flarestamina.com/og-image.png?v=2',
     current='/privacy/',
     extra_head='<script type="application/ld+json">\n' + '{"@context": "https://schema.org", "@graph": [{"@type": "WebPage", "@id": "https://flarestamina.com/privacy/#page", "url": "https://flarestamina.com/privacy/", "name": "Privacy — Flarestamina", "description": "What Flarestamina stores, where it lives, and how to delete it.", "inLanguage": "en", "dateModified": "2026-08-22", "isPartOf": {"@id": "https://flarestamina.com/#website"}, "publisher": {"@id": "https://flarestamina.com/#org"}}, {"@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Flarestamina", "item": "https://flarestamina.com/"}, {"@type": "ListItem", "position": 2, "name": "Privacy", "item": "https://flarestamina.com/privacy/"}]}]}' + '\n</script>\n',
     uz={
       'kicker': 'Maxfiylik', 'h1': 'Qisqa va halol.', 'updated': 'Oxirgi yangilanish: 22-avgust, 2026',
       ...
       'l11': 'Sizning kelganingizni uchinchi tomon ko‘rmaydi. Shriftlar Google Fonts’dan emas, shu saytdan beriladi — ya’ni sahifani ochish IP manzilingizni boshqa hech kimga uzatmaydi.',
       'l12': 'Hisoblagichni o‘z brauzeringiz uchun o‘chirib qo‘yishingiz mumkin: istalgan sahifani oxiriga <code>?nogc</code> qo‘shib oching. <code>?gc</code> qaytaradi.',
...
<section class="page-head">
  <div class="wrap narrow">
    ...
    <p class="lede mono" style="font-size:.8rem" data-i18n="updated">Last updated: 22 August 2026</p>
    <div class="rail"></div>
  </div>
</section>
  ...
  <div class="wrap narrow">
    <div class="prose">
      ...
      <ul>
        ...
        <li data-i18n-html="l11">No third party sees you arrive. The fonts are served from this site, not from Google Fonts, so loading a page does not hand your IP address to anyone else.</li>
        <li data-i18n-html="l12">You can switch the counter off for your own browser: open any page with <code>?nogc</code> on the end. <code>?gc</code> turns it back on.</li>
      </ul>
...
page('404.html',
     ...
     extra_head='<script type="application/ld+json">\n' + '{"@context": "https://schema.org", "@graph": [{"@type": "WebPage", "@id": "https://flarestamina.com/404.html#page", "url": "https://flarestamina.com/404.html", "name": "Page not found — Flarestamina", "inLanguage": "en", "isPartOf": {"@id": "https://flarestamina.com/#website"}}, {"@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Flarestamina", "item": "https://flarestamina.com/"}, {"@type": "ListItem", "position": 2, "name": "Page not found", "item": "https://flarestamina.com/404.html"}]}]}' + '\n</script>\n',
